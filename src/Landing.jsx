  ...
  return (
    <div className="mx-auto max-w-7xl my-5 text-white grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 md:px-8 px-4 sm:my-10 items-center gap-6">
      ...
      <div className="my-4 col-span-full lg:order-3">
        <div className="grid tablet:grid-cols-2 grid-cols-1 gap-1">
          <picture>
            <img
              src={pic4}
              alt="Me"
          ...
          <section className="space-y-5 text-slate-300 tablet:order-last">
            ...
            <p className="text-[17px]">
              ...
              with is <strong className="text-blue-300">React.js (Client and Server components)</strong> and <strong>Next.js</strong>.{" "}
            ...
            <p className="text-[18px]">
              ...
              <p className="text-[18px]">
                  I made a promise to stay consistent in grinding LeetCode and writing a Medium article every day about what I learn. If you like to read too, you can visit me in
              <a
